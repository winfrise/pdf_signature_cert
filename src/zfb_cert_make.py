...
def main(cert_password):
    ...
    # 【第一步】生成根 CA (天威诚信) 的密钥和自签名证书
    root_key = generate_rsa_key()
    
    # 严格按照你提供的信息设置颁发者/主体信息
    root_name = x509.Name([
        x509.NameAttribute(NameOID.COUNTRY_NAME, u"CN"),
        x509.NameAttribute(NameOID.ORGANIZATION_NAME, u"北京天威诚信电子商务服务有限公司"),
        x509.NameAttribute(NameOID.ORGANIZATIONAL_UNIT_NAME, u"可信身份RSA"),
        x509.NameAttribute(NameOID.COMMON_NAME, u"天威诚信CA"),
    ])
    ...
    root_cert = sign_certificate(
        ...
        is_ca=True,
        days_valid=40*365 # 40年有效期
    )
    print(">> 根 CA (天威诚信) 生成完毕")
    ...
    for user in users:
        ...
        user_cert = sign_certificate(
            ...
            issuer_name=root_name, # 颁发者是根 CA
